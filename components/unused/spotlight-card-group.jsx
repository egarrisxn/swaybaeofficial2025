...
export function SpotlightCardGroup() {
  return (
    <>
      <section className='relative flex h-[550px] flex-col justify-center overflow-hidden'>
              ...
              <div className='relative z-20 h-full overflow-hidden rounded-[inherit] bg-slate-900 p-6 pb-8'>
                ...
                <div className='flex h-full flex-col items-center text-center'>
                  ...
                  <div className='mb-5 grow'>
                    <h2 className='mb-1 text-xl font-bold text-slate-200'>Amazing Integration</h2>
