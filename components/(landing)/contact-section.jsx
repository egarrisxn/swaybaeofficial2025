...
export default function ContactSection() {
  return (
    <section className='border-4 border-white py-12 dark:border-black'>
      <div className='container mx-auto my-24 max-w-2xl border-2 px-4 lg:max-w-4xl'>
        <div className='grid grid-cols-1 place-items-center gap-6 lg:place-items-start lg:gap-8'>
          {/* Text Section */}
          <div className='flex w-full flex-col gap-1 border-2 p-2 sm:px-12 lg:gap-3 lg:p-2'>
          ...
          {/* Contact Section */}
          <div className='flex w-full flex-col gap-1 border-2 p-2 sm:px-10 lg:p-2'>
            <ContactForm />
