  ...
  'inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0',
  {
    variants: {
      variant: {
        ...
        threedee:
          'border-2 duration-200 rounded-3xl text-black bg-white uppercase leading-relaxed transition-all active:translate-x-[0.07rem] active:translate-y-[0.07rem] shadow-[3px_3.5px_0px_black] hover:shadow-[1px_1px_0px_black,-1.5px_-1.5px_0px_black] active:shadow-[0px_0px_0px_black] dark:shadow-[2px_3px_0px_#a9a9a9] dark:hover:shadow-[1px_1.5px_0px_#a9a9a9] dark:active:shadow-[0px_0px_0px_#a9a9a9]',
      ...
      size: {
        ...
        icon: 'p-2',
        stubby: 'px-6 py-3',
        thick: 'h-12 py-2 px-4 w-full max-w-[300px]',
