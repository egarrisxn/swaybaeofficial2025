...
export function PopoverFormButton({loading, text = 'submit'}) {
  return (
    <button
      type='submit'
      className='w-26 ml-auto flex h-6 items-center justify-center overflow-hidden rounded-md bg-gradient-to-b from-primary/90 to-primary px-3 text-xs font-semibold text-primary-foreground shadow-[0_0_1px_1px_rgba(255,255,255,0.08)_inset,0_1px_1.5px_0_rgba(0,0,0,0.32),0_0_0_0.5px_#1a94ff]'
    >
...
export function PopoverForm({
  ...
  return (
    ...
    <div key={title} className='flex border-2'>
      <motion.button
