...
const LargeDock = ({items, className}) => {
  ...
  return (
    <motion.div
      ...
      className={cn(
        'mx-auto hidden h-16 items-end gap-4 rounded-2xl bg-white/10 px-4 pb-3 md:flex dark:bg-black/10', // Large dock styles
        className,
...
export function AnimatedDock({items, largeClassName, smallClassName}) {
  return (
    <>
