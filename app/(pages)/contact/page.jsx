    ...
    <section className='min-h-screen w-full py-12'>
      <div className='container mx-auto my-24 max-w-2xl px-4 lg:max-w-7xl xl:px-0'>
        <div className='mx-auto grid max-w-[65ch] grid-cols-1 items-center leading-relaxed xl:max-w-[80ch]'>
          <h2 className='mb-4 font-serif text-[1.5em] font-bold leading-snug text-[#111827] xl:text-[1.9em] xl:leading-none dark:text-white'>
            Contact
          </h2>
          <h5>Official Bio</h5>
          <p className='mb-[1.25em] mt-[1.25em] max-w-5xl leading-relaxed text-[#374151] xl:text-[1.25rem] dark:text-[#d1d5db]'>
